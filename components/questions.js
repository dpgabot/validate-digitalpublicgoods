...
export default function Questions (props) {
	...
	return (
		<div className='mt-1 mb-5'>
			...
			<Row className="pt-2">
				<Col xs={{span:4, offset:2}} className="text-center">
					<Button
						...
						style={{width: '80px'}}
						variant="success"
						onClick={e => {setAnswer(true), setNext(true)}}
					>
						Yes
					</Button>
				</Col>
				<Col xs={4} className="text-center">
					<Button
						...
						style={{width: '80px'}}
						variant="danger"
						onClick={e => {setAnswer(false), setNext(true)}}
					>
						No
					</Button>
				</Col>
		    ...
		    />
		    <div className={error ? 'alert-danger p-1' : 'd-none'}>Please choose a value for your degree of confidence.</div>
